    ...
    <div> 
        <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            <ul class="breadcrumb">
				...
				<li class="active">Road Type</li>
            </ul>
            <div class="pull-right">
               <button class="btn btn-success btn-sm" type="button" @click="showmodal()"><span class="fa fa-plus"> Add New Road Type</span></button>
            </div>
        </div>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title">Adding New Road Type</h4>
					</div>
		...
		<div class="modal fade" id="deletemodal" tabindex="-1" role="dialog">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="bootbox-close-button close" data-dismiss="modal" aria-hidden="true">×</button>
						<h4 class="modal-title">Deleting Road Type</h4>
					</div>
					<div class="modal-body">
						<div class="bootbox-body">
							<form class="bootbox-form">
								<div class="row">
									<div class="col-xs-12 alert alert-danger">
										<span class="">Are you sure you wish to delete the selected Road Type?</span>
